...
import com.famiforth.Absyn.EntryPoint.Visitor;
...
public class VisitSkel {
  ...
  public class StatementVisitor<R, A> implements com.famiforth.Absyn.Statement.Visitor<R, A> {
  ...
  public class ExprVisitor<R, A> implements com.famiforth.Absyn.Expr.Visitor<R, A> {
    public R visit(com.famiforth.Absyn.Conditional p, A arg) {
      /* Code for Conditional goes here */
      p.statement_.accept(new StatementVisitor<R, A>(), arg);
      return null;
    }

    public R visit(com.famiforth.Absyn.Loop p, A arg) {
      /* Code for Loop goes here */
      p.statement_.accept(new StatementVisitor<R, A>(), arg);
      return null;
    }

    public R visit(com.famiforth.Absyn.Define p, A arg) {
  ...
  public class WordVisitor<R, A> implements com.famiforth.Absyn.Word.Visitor<R, A> {
  ...
  public class ConstantVisitor<R, A> implements com.famiforth.Absyn.Constant.Visitor<R, A> {
